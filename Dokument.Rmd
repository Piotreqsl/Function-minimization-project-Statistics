...
Rosenbrock2dResultsGA <- replicate(50,ga("real-valued",fitness = function(x) -rosenbrock2d(x),lower = replicate(2,-30),upper = replicate(2,30),maxiter=1000)@fitnessValue*-1)
Rosenbrock10dResultsGA <- replicate(50,ga("real-valued",fitness = function(x) -rosenbrock10d(x),lower = replicate(10,-30),upper = replicate(10,30),maxiter=1000)@fitnessValue*-1)
Rosenbrock20dResultsGA <- replicate(50,ga("real-valued",fitness = function(x) -rosenbrock20d(x),lower = replicate(20,-30),upper = replicate(20,30),maxiter=1000)@fitnessValue*-1)

Schwefel2dResultsGA <- replicate(50,ga("real-valued",fitness =function(x) - schwefel2d(x),lower = replicate(2,-500),upper = replicate(2,500),maxiter = 1000)@fitnessValue*-1)
Schwefel10dResultsGA <- replicate(50,ga("real-valued",fitness =function(x) - schwefel10d(x),lower = replicate(10,-500),upper = replicate(10,500),maxiter = 1000)@fitnessValue*-1)
Schwefel20dResultsGA <- replicate(50,ga("real-valued",fitness =function(x) - schwefel20d(x),lower = replicate(20,-500),upper = replicate(20,500),maxiter = 1000)@fitnessValue*-1)
